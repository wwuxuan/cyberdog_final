...
void ConvexMpcMotionGaits::SetDefaultParams() {
    ...
    rpy_cmd_min_ << -0.47, -0.2, 0.0;  // only pitch is enabled
    rpy_cmd_max_ << 0.47, 0.2, 0.0;
...
void ConvexMpcMotionGaits::SetCmd( ControlFsmData< float >& data ) {
    ...
    rpy_des_( 0 ) = rpy_des_last_[ 0 ] * ( 1.0 - body_pitch_filter_ ) + rpy_cmd_[ 0 ] * body_pitch_filter_;  
    rpy_des_( 0 ) = WrapRange( rpy_des_( 0 ), rpy_cmd_min_[ 0 ], rpy_cmd_max_[ 0 ] );
